    ...
    int       nCmdShow)
{
    ...
    return YijingPlayer::createAndRun();
}

int YijingPlayer::createAndRun(void)
{
    YijingPlayer *host = YijingPlayer::sharedInstance();
    int ret = host->run();
    YijingPlayer::purgeSharedInstance();
    return ret;
}

YijingPlayer *YijingPlayer::s_sharedInstance = NULL;

YijingPlayer *YijingPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new YijingPlayer();
    }
    return s_sharedInstance;
}

void YijingPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
YijingPlayer::YijingPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int YijingPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "yijing-player");
...
void YijingPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void YijingPlayer::createViewMenu(void)
{
...
void YijingPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void YijingPlayer::updateWindowTitle(void)
{
}

void YijingPlayer::relaunch(void)
{
...
void YijingPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void YijingPlayer::onFileOpenProject(void)
{
...
void YijingPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"YijingPlayer");
...
void YijingPlayer::onFileProjectConfig(void)
{
...
void YijingPlayer::onFileRelaunch(void)
{
    relaunch();
}

void YijingPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void YijingPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void YijingPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void YijingPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void YijingPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT YijingPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    YijingPlayer *host = YijingPlayer::sharedInstance();
...
INT_PTR CALLBACK YijingPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
